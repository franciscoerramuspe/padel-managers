...
import { createLeague, joinLeague, getLeaguesByUser, getLeagueById, getAllLeagues, generateStandings, getStandings, getStandingById, updateMatchResult, updateMatchSchedule } from '../controllers/league.controller.js'
...
router.post('/match/result/:id', verifyToken, verifyAdmin, updateMatchResult);
