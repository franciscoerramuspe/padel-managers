              ...
              <div className="p-4">
                ...
                <div className="flex justify-between">
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 text-sm px-4 rounded transition duration-300 ease-in-out flex items-center"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <button
                    ...
                    className="bg-red-500 hover:bg-red-600 text-white font-bold text-sm py-2 px-4 rounded transition duration-300 ease-in-out flex items-center"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
